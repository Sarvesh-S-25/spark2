...
**2. Read the invariants.** `AGENTS.md` at the repo root lists twelve things that
...
- the relevant invariants from `AGENTS.md`, quoted, so the plan respects them
...
- Does it contradict an invariant in `AGENTS.md`?
